...
// Make APIClient accessible globally
@objc public class APIClient: NSObject {
    ...
    @objc public func createTestConversation(initialMessage: String) -> AnyPublisher<Conversation, APIError> {
    ...
    @objc public func addMessageToTestConversation(conversationId: String, content: String) -> AnyPublisher<Conversation, APIError> {
    ...
    @objc public func getAllTestConversations() -> AnyPublisher<[Conversation], APIError> {
        let endpoint = "\(baseURL)/conversations/test"
